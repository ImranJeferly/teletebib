        ...
        <div className="container mx-auto px-4 overflow-hidden">
                ...
                <div className="p-6">                  {/* Category & Date */}
                  ...
                  >
                    {searchQuery.trim() && findMatchingSnippet(blog, searchQuery) ? (
                      <div>
                        <strong className="text-xs uppercase tracking-wide" style={{ color: PRIMARY }}>
                          Tapılmış nəticə:
                        </strong>
                        <p className="mt-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    </span>                    <div className="flex items-center gap-1 text-xs" style={{ color: FOREGROUND_LIGHT }}>
          ...
          {!loading && !error && posts.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold mb-2" style={{ color: FOREGROUND }}>
                {searchQuery ? 'Heç bir nəticə tapılmadı' : 'Blog yazıları yoxdur'}
              </h3>
              <p style={{ color: FOREGROUND_LIGHT }}>
                {searchQuery ? 'Başqa axtarış sözləri sınayın' : 'Yaxın zamanda blog yazıları əlavə ediləcək'}
              </p>
            </div>
          )}
